# ============================================================
# FULL RESET + DEPLOY (both accounts)
# Run from: ~/Documents/GitHub
# ============================================================

# --- 1. Teardown both accounts ---
cd ~/Documents/GitHub/snowflake-rbac-framework
snow sql -f scripts/99_teardown.sql -c DEVACC --role ACCOUNTADMIN --warehouse COMPUTE_WH
snow sql -f scripts/99_teardown.sql -c PRODACC --role ACCOUNTADMIN --warehouse COMPUTE_WH
